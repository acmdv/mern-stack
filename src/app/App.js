...
class App extends Component{
    ...
    constructor(){
        super(); // hereda todas las propiedades del Component
        this.state = {
            title:'',
            description:'',
            tasks: [],
                                ...
                                <div className="card-content">
                                    ...
                                    <div className="row">
                                            <div className="input-field col s12">
                                                <input type="text" name="title" onChange={this.handleChange} placeholder="Input Task" value={this.state.title}></input>
                                            </div>
                                        </div>
                                        <div className="row">
                                            <div className="input-field col s12">
